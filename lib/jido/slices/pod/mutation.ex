defmodule Jido.Slices.Pod.Mutation do
  @moduledoc """
  ...
  defmodule Plan do
    ...
    @type t :: %__MODULE__{
            ...
            added: [Jido.Slices.Pod.Mutation.node_name()],
            removed: [Jido.Slices.Pod.Mutation.node_name()],
            start_requested: [Jido.Slices.Pod.Mutation.node_name()],
            start_waves: [[Jido.Slices.Pod.Mutation.node_name()]],
            stop_waves: [[Jido.Slices.Pod.Mutation.node_name()]],
            removed_nodes: %{Jido.Slices.Pod.Mutation.node_name() => Node.t()},
            report: Report.t(),
            start_state_overrides: %{Jido.Slices.Pod.Mutation.node_name() => map()}
          }
  end
