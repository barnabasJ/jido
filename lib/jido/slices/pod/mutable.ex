defmodule Jido.Slices.Pod.Mutable do
  @moduledoc false

  alias Jido.Agent
  alias Jido.AgentServer
  alias Jido.Slices.Pod
  alias Jido.Slices.Pod.Directives.StartNode
  alias Jido.Slices.Pod.Directives.StopNode
  alias Jido.Slices.Pod.Mutation
  alias Jido.Slices.Pod.Mutation.Plan
  alias Jido.Slices.Pod.Mutation.Planner
  alias Jido.Slices.Pod.TopologyState
  alias Jido.Signal

  # Pod plugin mounts at the reserved `:pod` slice key — see
  # `Jido.Slices.Pod.TopologyState` for the same constant.
  @pod_state_key :pod
  ...
  defp finalize_report(%Jido.Slices.Pod.Mutation.Report{} = report, status) do
