defimpl Jido.AgentServer.DirectiveExec, for: Jido.Slices.Pod.Directives.StartNode do
  @moduledoc false
...
defimpl Jido.AgentServer.DirectiveExec, for: Jido.Slices.Pod.Directives.StopNode do
  @moduledoc false
