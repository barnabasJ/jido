...
When an agent registers a recurring job at runtime with `Directives.cron/3`,
...
- Dynamic `Directives.cron/3` registrations are persisted when storage is enabled
